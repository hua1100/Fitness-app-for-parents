...
<!-- LANGUAGE REQUIREMENT: This document MUST be written in Traditional Chinese (繁體中文) per Constitution Principle 1 -->
...
☑ Principle 1 (Documentation Language): All documentation in Traditional Chinese ✓
☑ Principle 2 (Simplicity First): Complexity justified in Complexity Tracking table
☑ Principle 3 (Test-Driven Validation): Tests written before implementation (if requested)
☑ Principle 4 (Independent User Stories): Each story independently implementable/testable
☑ Principle 5 (Constitution Gates): Check completed before Phase 0 and after Phase 1
☑ Principle 6 (Explicit Over Implicit): All ambiguities marked NEEDS CLARIFICATION
☑ Principle 7 (Semantic Versioning): N/A for implementation plans

Violations: [List any violations with justification, or state "None"]
...
| Violation | Why Needed | Simpler Alternative Rejected Because | |-----------|------------|-------------------------------------| | [e.g., 4th project] | [current need] | [why 3 projects insufficient] | | [e.g., Repository pattern] | [specific problem] | [why direct DB access insufficient] |